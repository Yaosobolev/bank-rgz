import { useCreditExpert, useReportUsersCredit } from "@/api/hooks/useReport";
import {
  Table,
  TableBody,
  TableCell,
...
export const ReportCreditExpert = () => {
  ...
  const { data, refetch } = useCreditExpert(bankId);
      ...
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Все кредиты эксперта</FormLabel>
                <FormControl>
                  <Input
